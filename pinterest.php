...
class mg_Pinterest_Strips extends WP_Widget {
	function __construct() {
		...
		parent::__construct(
			...
			'Wordcomat Pinterest', // Name
			array('description' => __( 'Display  Pinterest images', 'text_domain' ))
		);
	...
	function widget($args, $instance) {
		...
		$title = $board ?
			...
			"<a href='http://pinterest.com/$username/$board'>$board</a>"
			: 
			"<a href='http://pinterest.com/$username'>$username</a>" ;
